...
describe('SystemArchitectureView Component', () => {
  it('renders pipeline blueprint and security guarantees', () => {
    ...
    expect(screen.getAllByText(/Kétirányú Google Drive Szinkronizáció/i).length).toBeGreaterThan(0);
    ...
    expect(screen.getAllByText(/Zero Cloud Data Leakage/i).length).toBeGreaterThan(0);
  });
});
