...
describe('Uplink Component Suite', () => {
  ...
  it('associates every public contact field with a visible label', () => {
    render(
      <ContentProvider>
        <Uplink />
      </ContentProvider>
    ...
    expect(screen.getByRole('textbox', { name: /NÉV_ÉS_EMAIL/i })).toBeRequired();
    expect(screen.getByRole('textbox', { name: /TÉMA/i })).toBeRequired();
